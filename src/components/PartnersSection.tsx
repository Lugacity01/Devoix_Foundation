...
export const PartnersSection: React.FC = () => {
  ...
  return (
    <section id="partners" className="py-14 sm:py-16 lg:py-20 xl:py-24 2xl:py-28 bg-white text-black relative overflow-hidden border-b border-zinc-200 selection:bg-black selection:text-white">
      ...
      <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between pb-6 sm:pb-8 mb-8 sm:mb-10 2xl:mb-12 border-b border-zinc-200 gap-4 sm:gap-6">
          <div>
            ...
            <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-black tracking-tight leading-snug sm:leading-tight">
              Powering the{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 xl:gap-6 mb-10 sm:mb-12 2xl:mb-16">
          {partners.map((p) => {
            ...
            return (
              <div
                key={p.id}
                className={`relative rounded-2xl sm:rounded-3xl bg-zinc-50 border border-zinc-200 p-4 sm:p-5 lg:p-6 flex flex-col justify-between transition-all duration-300 group overflow-hidden ${p.borderColor} hover:shadow-xl hover:-translate-y-1.5 hover:bg-white`}
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-3.5 sm:mb-4 pb-3 border-b border-zinc-200">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-white border border-zinc-200 shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:border-black transition-all shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-mono font-semibold text-zinc-600 mt-0.5">
                        {p.category}
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative z-10 pt-3 border-t border-zinc-200 flex items-center justify-between text-[11px] sm:text-xs font-mono">
                  <div>
        ...
        <div className="relative rounded-xl sm:rounded-2xl bg-black text-white p-3 sm:p-3.5 overflow-hidden border border-zinc-800 shadow-md mb-8 sm:mb-10">
        ...
        <div className="p-5 sm:p-6 2xl:p-8 rounded-2xl sm:rounded-3xl bg-zinc-900 text-white border border-zinc-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 shadow-xl">
          <div className="flex items-center gap-3.5 sm:gap-4">
            <div className="w-9 h-9 sm:w-10 sm:h-10 2xl:w-11 2xl:h-11 rounded-xl bg-white text-black flex items-center justify-center shrink-0">
          ...
          <a
            href="/contact"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 sm:py-3 rounded-xl bg-white hover:bg-zinc-200 text-black font-mono text-xs font-bold uppercase tracking-wider transition-all hover:scale-[1.01] shrink-0 text-center"
          >
