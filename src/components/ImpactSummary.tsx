      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5 sm:gap-4 mb-10 sm:mb-14">
          {impactStats.map((stat, idx) => (
            <div
              key={idx}
              className="p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:border-purple-400 transition-all group"
            >
              <div className="font-mono text-[9px] sm:text-[10px] font-bold text-purple-600 uppercase tracking-widest mb-2 sm:mb-3">
                METRIC // 0{idx + 1}
              </div>

              <div className="font-display text-2xl sm:text-3xl lg:text-3xl xl:text-4xl font-black text-slate-900 group-hover:text-purple-600 transition-colors mb-1 sm:mb-2">
                {stat.number}
              </div>
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-[#080312] text-white border-2 border-purple-500/30 overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-0 shadow-xl">
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 lg:p-10 flex flex-col justify-between relative">
            <Quote className="w-8 h-8 sm:w-10 sm:h-10 text-purple-500/30 mb-4 sm:mb-6" />
            ...
            <div className="pt-4 sm:pt-6 border-t border-purple-900/40 flex items-center gap-3.5">
              <img
                ...
                alt="Ebuka Prince"
                className="w-10 h-10 sm:w-11 sm:h-11 rounded-full object-cover border-2 border-purple-400 shrink-0"
              />
              <div>
          ...
          <div className="lg:col-span-5 relative min-h-[220px] sm:min-h-[280px] lg:min-h-[auto] bg-slate-900 overflow-hidden">
            ...
            <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 p-3 sm:p-4 rounded-xl bg-[#080312]/90 border border-purple-500/30">
              <span className="text-[9px] sm:text-[10px] font-mono font-bold text-purple-300 uppercase tracking-wider block mb-0.5">
