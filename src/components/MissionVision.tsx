    ...
    <section id="mission" className="py-16 sm:py-20 lg:py-24 bg-[#fafafa] text-slate-900 relative overflow-hidden border-b border-[#e5e5e5] selection:bg-[#000000] selection:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-reveal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          {/* Mission Card */}
          <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-[#e5e5e5] hover:border-[#000000]/40 hover:scale-[1.01] transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-[#e5e5e5] hover:border-[#000000]/40 hover:scale-[1.01] transition-all duration-300 relative overflow-hidden group">
            ...
            <h3 className="font-display text-lg sm:text-xl font-bold text-[#000000] mb-3 leading-snug group-hover:text-[#3a3938] transition-colors">
              Leading African Creative & Social Impact
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {coreValues.map((v, i) => {
              ...
              return (
                <div
                  key={i}
                  className="relative p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-white border border-[#e5e5e5] hover:border-[#000000]/40 hover:scale-[1.01] transition-all duration-300 group overflow-hidden flex flex-col justify-between"
                >
                  {/* Scaled Watermark Number */}
                  <div className="absolute top-2 right-4 sm:top-4 sm:right-6 font-display text-5xl sm:text-6xl font-black text-slate-100 group-hover:text-slate-200 transition-colors pointer-events-none select-none">
                    {v.num}
                  </div>
