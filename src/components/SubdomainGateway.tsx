...
export const SubdomainGateway: React.FC = () => {
  return (
    <section id="gateway" className="py-16 sm:py-20 lg:py-24 bg-[#080312] text-white relative overflow-hidden border-b border-purple-900/30 selection:bg-purple-600 selection:text-white">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[800px] h-[300px] sm:h-[400px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="rounded-2xl sm:rounded-3xl bg-[#0D071E]/90 border-2 border-purple-500/30 overflow-hidden flex flex-col justify-between hover:border-purple-400/80 transition-all group">
            <div className="p-6 sm:p-8 lg:p-9">
              
              {/* Arm Header Badge */}
              <div className="flex items-center justify-between mb-4 sm:mb-6 pb-3.5 sm:pb-4 border-b border-purple-900/30">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-purple-500/20 border border-purple-500/40 flex items-center justify-center text-purple-300 font-bold shrink-0">
                    <Film className="w-5 h-5 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <h3 className="font-display text-lg sm:text-xl font-extrabold text-white">Dovoix FilmHouse</h3>
          ...
          <div className="rounded-2xl sm:rounded-3xl bg-[#0D071E]/90 border-2 border-violet-500/30 overflow-hidden flex flex-col justify-between hover:border-violet-400/80 transition-all group">
            <div className="p-6 sm:p-8 lg:p-9">
              
              {/* Arm Header Badge */}
              <div className="flex items-center justify-between mb-4 sm:mb-6 pb-3.5 sm:pb-4 border-b border-purple-900/30">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-violet-500/20 border border-violet-500/40 flex items-center justify-center text-violet-300 font-bold shrink-0">
                    <HeartHandshake className="w-5 h-5 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <h3 className="font-display text-lg sm:text-xl font-extrabold text-white">Dovoix Foundation</h3>
            ...
            <div className="p-6 sm:p-8 lg:p-9 pt-0">
              <Link
                href="/projects"
                className="w-full inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-white/10 hover:bg-white/15 text-white font-bold text-xs font-mono uppercase tracking-wider border border-white/20 transition-all shadow-md group-hover:scale-[1.01]"
              >
                <span>Explore Foundation</span>
                <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-300" />
              </Link>
            </div>
          </div>
