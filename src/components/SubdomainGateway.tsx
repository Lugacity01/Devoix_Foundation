...
export const SubdomainGateway: React.FC = () => {
  return (
    <section id="gateway" className="py-16 sm:py-20 lg:py-24 bg-black text-white relative overflow-hidden border-b border-zinc-900 selection:bg-white selection:text-black">
      {/* Background Ambient Spotlights */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[800px] h-[300px] sm:h-[400px] bg-zinc-800/15 rounded-full blur-[140px] pointer-events-none animate-pulse-glow" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="rounded-2xl sm:rounded-3xl bg-zinc-950 border-2 border-zinc-800 overflow-hidden flex flex-col justify-between hover:border-white/50 hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="p-6 sm:p-8 lg:p-9">
              ...
              {/* Arm Header Badge */}
              <div className="flex items-center justify-between mb-4 sm:mb-6 pb-3.5 sm:pb-4 border-b border-zinc-800">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-zinc-900 border border-zinc-700 flex items-center justify-center text-white font-bold shrink-0 group-hover:scale-110 transition-transform">
                    <Film className="w-5 h-5 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <h3 className="font-display text-lg sm:text-xl font-extrabold text-white group-hover:text-zinc-200 transition-colors">Dovoix FilmHouse</h3>
                    <span className="text-[11px] sm:text-xs font-mono text-zinc-400">filmhouse.dovoix.com</span>
                  </div>
                </div>
                <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-md bg-zinc-900 text-zinc-300 font-mono text-[9px] sm:text-[10px] font-bold uppercase tracking-wider border border-zinc-700">
                  COMMERCIAL ARM
                </span>
              </div>

              {/* Media Visual Stage */}
              <div className="relative aspect-[16/9] rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6 bg-zinc-900 border border-zinc-800">
                <img
                ...
                <div className="absolute bottom-2.5 left-2.5 right-2.5 sm:bottom-3 sm:left-3 sm:right-3 text-[10px] sm:text-xs font-mono font-bold text-white bg-black/90 p-2 sm:p-2.5 rounded-lg border border-zinc-800">
                  PORTFOLIO • RATE CARD • CLIENTS • BOOKINGS
                </div>
              </div>

              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-normal mb-4 sm:mb-6">
            ...
            <div className="p-6 sm:p-8 lg:p-9 pt-0">
              <a
                ...
                className="relative overflow-hidden w-full inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-white hover:bg-zinc-200 text-black font-bold text-xs font-mono uppercase tracking-wider transition-all shadow-md group-hover:scale-[1.02]"
              >
          ...
          <div className="rounded-2xl sm:rounded-3xl bg-[#0D071E] border-2 border-purple-500/40 overflow-hidden flex flex-col justify-between hover:border-purple-400 hover:shadow-[0_0_40px_rgba(157,78,221,0.3)] hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="p-6 sm:p-8 lg:p-9">
              ...
              {/* Arm Header Badge */}
              <div className="flex items-center justify-between mb-4 sm:mb-6 pb-3.5 sm:pb-4 border-b border-purple-900/40">
                <div className="flex items-center gap-2.5 sm:gap-3">
                  ...
                  <div>
                    <h3 className="font-display text-lg sm:text-xl font-extrabold text-white group-hover:text-purple-300 transition-colors">Dovoix Foundation</h3>
                    <span className="text-[11px] sm:text-xs font-mono text-purple-300">foundation.dovoix.com</span>
                  </div>
                </div>
                <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-md bg-purple-900/60 text-purple-200 font-mono text-[9px] sm:text-[10px] font-bold uppercase tracking-wider border border-purple-500/40">
                  PURPLE & BLACK ARM
                </span>
              </div>

              {/* Media Visual Stage */}
              <div className="relative aspect-[16/9] rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6 bg-slate-900 border border-purple-500/30">
                <img
              ...
              <p className="text-xs sm:text-sm text-purple-200/80 leading-relaxed font-normal mb-4 sm:mb-6">
            ...
            <div className="p-6 sm:p-8 lg:p-9 pt-0">
              <Link
                href="/projects"
                className="w-full inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-gradient-to-r from-purple-600 via-violet-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs font-mono uppercase tracking-wider border border-purple-400/50 shadow-md group-hover:scale-[1.02] transition-all"
              >
