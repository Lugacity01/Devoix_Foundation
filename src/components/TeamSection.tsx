  ...
  return (
    <section id="executives" className="py-14 sm:py-16 lg:py-20 xl:py-24 2xl:py-28 bg-[#0D071E] text-white relative overflow-hidden border-b border-purple-900/30 selection:bg-purple-600 selection:text-white">
      ...
      <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 relative z-10">
        ...
        {/* Executive Profile Cards Grid with crisp borders, no heavy shadows */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 xl:gap-6">
          {team.map((member) => (
            <div
              key={member.id}
              className="relative p-4 sm:p-4.5 2xl:p-5 rounded-2xl sm:rounded-3xl bg-[#080312]/90 border border-purple-500/30 flex flex-col justify-between hover:border-purple-400/80 hover:-translate-y-1 transition-all duration-300 group overflow-hidden"
            >
              <div className="relative z-10">
                {/* Headshot Frame with Max-Height Cap */}
                <div className="relative aspect-[4/3] sm:aspect-square max-h-[260px] 2xl:max-h-[300px] rounded-xl sm:rounded-2xl overflow-hidden mb-3.5 bg-slate-900 border border-purple-500/30">
                  <img
                    src={member.image}
                    alt={member.name}
                  ...
                  {member.isFounder && (
                    <span className="absolute top-2.5 left-2.5 px-2.5 py-0.5 rounded-md bg-[#080312]/95 border border-purple-500/50 text-purple-300 text-[9px] font-mono font-bold uppercase tracking-wider flex items-center gap-1">
              ...
              <div className="relative z-10 pt-3 border-t border-purple-900/40 flex items-center justify-between">
                ...
                {member.linkedin && (
                  <a
                    ...
                    className="p-1.5 rounded-lg bg-white/5 hover:bg-purple-500/20 text-slate-300 hover:text-purple-300 border border-purple-500/20 group-hover:border-purple-400/40 group-hover:scale-105 transition-all"
                  >
