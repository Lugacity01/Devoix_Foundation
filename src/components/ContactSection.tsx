...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 sm:py-28 bg-slate-50 text-slate-900 relative overflow-hidden border-b border-slate-200 selection:bg-black selection:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-black text-white text-xs sm:text-sm font-mono font-bold uppercase tracking-wider mb-4 shadow-md">
          ...
          <div className="lg:col-span-5 p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-slate-100 text-slate-900 border border-slate-200 flex items-center justify-center shrink-0">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <div className="text-[10px] font-mono text-slate-500 uppercase tracking-wider">EMAIL US</div>
                  <a href="mailto:dovoixfirm@gmail.com" className="text-sm font-semibold text-slate-900 hover:text-black transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/2348125615709" target="_blank" rel="noopener noreferrer" className="text-xs text-black font-bold hover:underline mt-0.5 font-mono inline-block">
                    Chat on WhatsApp →
                  </a>
                </div>
              </div>
            ...
            <div className="pt-6 border-t border-slate-100">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                <a
                  ...
                  className="p-3 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-900 border border-slate-200 transition-colors"
                >
          ...
          <div className="lg:col-span-7 p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-sm">
            ...
            {submitted ? (
              <div className="py-12 text-center">
                <div className="w-16 h-16 rounded-full bg-slate-100 text-slate-900 border border-slate-200 flex items-center justify-center mx-auto mb-4">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-black text-white font-bold text-xs font-mono uppercase tracking-wider hover:bg-slate-800"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 text-sm focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-black hover:bg-slate-800 text-white font-bold text-xs font-mono uppercase tracking-wider border border-black transition-all shadow-md"
                >
