      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-reveal">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="w-full lg:col-span-7 flex flex-col items-start text-left">
            ...
            {/* PRD Subheading */}
            <div className="space-y-3 sm:space-y-3.5 text-sm sm:text-base lg:text-lg text-[#999998] font-normal leading-relaxed mb-6 sm:mb-8 max-w-2xl">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-5 sm:pt-8 border-t border-[#3a3938]/40 w-full">
              <Link href="/filmhouse" className="flex items-center gap-3 p-3 sm:p-3.5 rounded-2xl bg-[#141414]/80 border border-[#3a3938]/60 hover:border-white/40 hover:bg-[#1a1a1a] transition-all group">
              ...
              <a href="#gateway" className="flex items-center gap-3 p-3 sm:p-3.5 rounded-2xl bg-[#141414]/80 border border-[#3a3938]/60 hover:border-white/40 hover:bg-[#1a1a1a] transition-all group">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#262626] border border-[#3a3938] flex items-center justify-center text-white font-bold shrink-0 group-hover:scale-105 transition-transform">
