      ...
      <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 2xl:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="space-y-3 sm:space-y-3.5 2xl:space-y-4 text-zinc-600 text-xs sm:text-sm lg:text-base font-normal leading-relaxed mb-6 sm:mb-7 2xl:mb-8 max-w-xl 2xl:max-w-2xl">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full mb-6 sm:mb-7 2xl:mb-8 pt-4 sm:pt-5 border-t border-zinc-100 max-w-xl 2xl:max-w-2xl">
              <div className="p-3.5 sm:p-4 2xl:p-5 rounded-2xl bg-zinc-50 border border-zinc-200 hover:border-black hover:shadow-md transition-all group">
                <div className="flex items-center gap-2 text-black font-mono text-xs font-bold uppercase tracking-wider mb-1.5">
              ...
              <div className="p-3.5 sm:p-4 2xl:p-5 rounded-2xl bg-zinc-50 border border-zinc-200 hover:border-purple-600 hover:shadow-md transition-all group">
                <div className="flex items-center gap-2 text-purple-700 font-mono text-xs font-bold uppercase tracking-wider mb-1.5">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-1">
              ...
              <a
                href="#mission"
                className="inline-flex items-center gap-1.5 text-xs font-mono font-bold text-black hover:text-zinc-600 uppercase tracking-wider group"
              >
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0 flex justify-center">
            <div className="relative w-full max-w-md lg:max-w-sm xl:max-w-md 2xl:max-w-lg animate-float-slow">
              ...
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-zinc-200 shadow-xl bg-zinc-100 aspect-[4/3] sm:aspect-[16/11] lg:aspect-[4/5] max-h-[380px] sm:max-h-[440px] lg:max-h-[460px] 2xl:max-h-[500px] group hover:shadow-2xl transition-shadow duration-500">
                ...
                {/* Overlay Badge */}
                <div className="absolute bottom-3 left-3 right-3 sm:bottom-3.5 sm:left-3.5 sm:right-3.5 p-3 sm:p-3.5 rounded-xl bg-black/90 border border-white/10 backdrop-blur-md">
                  ...
                  <p className="text-[10px] sm:text-[11px] text-white leading-snug">
